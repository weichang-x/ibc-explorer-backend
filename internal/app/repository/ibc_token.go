...
type ITokenRepo interface {
	...
	UpdateToken(bulk *qmgo.Bulk, token *entity.IBCToken) error
	Bulk() *qmgo.Bulk
...
func (repo *TokenRepo) Bulk() *qmgo.Bulk {
...
func (repo *TokenRepo) UpdateToken(bulk *qmgo.Bulk, token *entity.IBCToken) error {
