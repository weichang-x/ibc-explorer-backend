...
import (
	...
	"github.com/irisnet/ibc-explorer-backend/internal/app/api/middleware"
	"github.com/irisnet/ibc-explorer-backend/internal/app/api/rest"
...
func txsPage(r *gin.RouterGroup) {
	...
	r.GET("/txs/txs_volume", cache.CachePage(store, time.Duration(aliveSeconds)*time.Second, ctl.TransferTxsVolume))
